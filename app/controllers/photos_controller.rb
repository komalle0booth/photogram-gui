class PhotosController < ApplicationController
  ...
  def update
    ...
    modify_image = params.fetch("input_image")

    modify_caption = params.fetch("input_caption")

    the_photo.image = modify_image

    the_photo.image = modify_caption
